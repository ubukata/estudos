...
var player = {
    ...
    initialize: function () {
        ...
        var path = cordova.file.dataDirectory.replace('file://','') + '_audio/' + player.audioName;
        this.media = new Media(path, this.onMediaSuccess, this.onMediaError, this.onMediaStatus);

        $("#audio-name").html(player.audioName);
